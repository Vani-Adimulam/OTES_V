...
const getMCQQuestionsForTest = () => {
  ...
  async function handleNextClick() {
    ...
    try {
      const response1 = await axios.post(`${BASE_URL}/testresults`, requestBody);
      ...
      const response2 = await axios.patch(`${BASE_URL}/updateCandidateTeststatus`, requestBody2);
      ...
      console.log(error);
      toast.warn('Failed to update Test Results or Test Status.');
      setLoading(false);
    }
  }
  ...
  return (
    <div>
      <div style={{ backgroundColor: '', position: 'fixed', top: 0, left: 0, right: 0, zIndex: 999, marginTop: '90px', marginLeft: '20px', textAlign: 'end' }}>
        <div style={{ marginRight: '20px', marginTop: '15px' }}><Timer /></div>
      </div>
      <div style={{ paddingTop: '100px' }}>
      <h2 style={{ marginTop: '0px', marginLeft: '20px', backgroundColor: '' }}>MCQ Questions</h2>
        <div className="mcq-questions-list">
          {mcqquestions.map((question) => (
            <div key={question._id} className="card" style={{ width: '100%', marginTop: '10px' }}>
              <div className="card-header">
          ...
          <div>
            {loading ? (
              ...
              <button
                ...
                type="submit" id='submit_test_auto'
